            ...
            ?>
             ...
             <tr class="form-field">
		        <th scope="row" valign="top">
                    <br>
		        	<label for="category-title"><?php echo $this->taxmeta_name; ?></label>
                </th>
		        <td>
            ...
            switch ($this->taxmeta_type) {
                ...
                case 'select':
                    ...
                    >
                        ...
                        <option <?php if ($value == $select_option['value']) { ;?> selected <?php } ?> value="<?php echo $select_option['value'];?>"><?php echo $select_option['name'];?></option>
                        <?php } ?>
                    </select>
